 ...
 * @author Carlos
 */
public class VentanaGangas extends javax.swing.JFrame {
     ...
     * @param vM
     */
    public VentanaGangas(VentanaMenu vM) {
        this.vM = vM;
        initComponents();
        rellenoMensaje();
    ...
    private void rellenoMensaje(){
        textAreaMuestra.setText(gestora.GestorCoches.cochesGanga());
    }
